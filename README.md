...
**Welcome to FPathai** (**F**riendly **PATH**ology application for **A**rtificial **I**ntelligence), an innovative application tailored for the world of histopathological image analysis 
